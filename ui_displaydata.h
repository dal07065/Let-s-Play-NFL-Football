...
public:
    ...
    {
        DisplayData->setWindowTitle(QCoreApplication::translate("DisplayData", "Displaying Data", nullptr));
        pushButton->setText(QCoreApplication::translate("DisplayData", "Close", nullptr));
    } // retranslateUi
